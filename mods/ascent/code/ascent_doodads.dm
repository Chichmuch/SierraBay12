...
/obj/structure/table/steel_reinforced/ascent
	material = "grey_steel"
	icon = 'mods/ascent/icons/obj/structures/table.dmi'
	color = COLOR_OFF_WHITE


/obj/structure/table/ascent/New()
	..()
